...
.pill{{
  ...
  color:var(--muted);
  animation:fadeDown 0.6s cubic-bezier(.16,1,.3,1);
}}
...
.pipeline::before{{
  content:'PIPELINE';position:absolute;top:8px;left:16px;
  font-size:7px;font-weight:800;letter-spacing:3px;color:rgba(255,255,255,0.1);
}}
...
.p-icon{{
  ...
  box-shadow:0 0 10px color-mix(in srgb,var(--p1) 25%,transparent),inset 0 0 10px color-mix(in srgb,var(--p1) 8%,transparent);
}}
.p-icon:hover{{
...
.card{{
  ...
  position:relative;overflow:hidden;
  box-shadow:0 8px 32px rgba(0,0,0,0.5),0 0 0 1px rgba(255,255,255,0.06),inset 0 1px 0 rgba(255,255,255,0.08);
...
.card::after{{
  ...
  opacity:0.4;animation:bargl 3s ease-in-out infinite alternate;
}}
...
<div class="wrap">
  ...
  <div class="hero">
    ...
    <h1>
      <span class="w">MULTI</span><span class="a">CLOUD</span><br>
      <span class="w">CI</span><span class="a">/</span><span class="w">CD</span>
    </h1>
    <div class="hero-sub">
  ...
  <div class="pipeline">
    <div class="pstep">
      ...
      <div class="p-label">Code</div>
    </div>
    <div class="pconn"><div class="pline"></div></div>
    <div class="pstep">
      <div class="p-icon"><i class="fa-brands fa-github"></i></div>
      <div class="p-label">GitHub</div>
    </div>
    <div class="pconn"><div class="pline"></div></div>
    <div class="pstep">
      <div class="p-icon"><i class="fa-brands fa-docker"></i></div>
    ...
    <div class="pstep">
      <div class="p-icon">
        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          <path fill="#fff" d="M16 2a1.3 1.3 0 0 0-.5.1L5.1 7.2a1.3 1.3 0 0 0-.7 1L3.1 19.7a1.3 1.3 0 0 0 .3 1l7.6 8.6a1.3 1.3 0 0 0 1 .4h8.1a1.3 1.3 0 0 0 1-.4l7.6-8.6a1.3 1.3 0 0 0 .3-1L27.6 8.2a1.3 1.3 0 0 0-.7-1L16.6 2.1A1.3 1.3 0 0 0 16 2zm.1 2.1l9.8 4.8 1.2 10.7-7 7.9h-7.9l-7-7.9 1.2-10.7zm-.1 4a1 1 0 0 0-1 1v6.2l-4 2.4a1 1 0 1 0 1 1.7L16 17l4 2.4a1 1 0 1 0 1-1.7l-4-2.4V9a1 1 0 0 0-1-1z"/>
        </svg>
      </div>
    ...
    <div class="pstep">
      <div class="p-icon">
        {'<i class="fa-brands fa-aws"></i>' if cloud.lower()=='aws' else
         '<i class="fa-brands fa-google"></i>' if cloud.lower()=='gcp' else
  ...
  <div class="cards">
    ...
    <div class="card">
      <div class="card-top"><div class="card-icon"><i class="fa-solid fa-server"></i></div><div class="card-ping"></div></div>
      <div class="card-label">Hostname</div>
      <div class="card-value">{hostname[:10]}</div>
      <div class="card-sub">Pod identifier</div>
    </div>
    <div class="card">
    ...
    <div class="card">
      <div class="card-top"><div class="card-icon"><i class="fa-brands fa-github"></i></div><div class="card-ping"></div></div>
      <div class="card-label">Pipeline</div>
      <div class="card-value">GH Actions</div>
      <div class="card-sub">Auto deploy</div>
    </div>
    <div class="card">
